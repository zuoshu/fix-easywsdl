...
public class ExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://localhost/lemoninfo.wsdl^^optResponse",optResponse.class);
        classNames.put("http://localhost/lemoninfo.wsdl^^menusResponse",menusResponse.class);
    }   
