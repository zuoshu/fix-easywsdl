...
public class optResponse extends AttributeContainer implements KvmSerializable
{
    ...
    public optResponse (Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
